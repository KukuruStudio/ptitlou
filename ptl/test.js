...
loader.addFinishHandler(function() {
    ...
    console.log("[ptl] Define ptl.test");

    qx.Class.define("ptl.test", {
        type : "singleton",
        ...
        members : {
            ...
            initialize : function () {
                try {
                    ...
                    this.serverBar.add(btn, {top: 2, left: 480});
                } catch (e) {
                    console.log("[ptl] ERROR ptl.test.initialize: " + e);
                }
            },
    ...
    function StartLouExtensions(){
        ...
        if( app && app.serverBar ) {
            console.log("[ptl] StartLouExtensions");
            ptl.test.getInstance().initialize();
        } else {
            console.log("[ptl] Retrying StartLouExtensions");
